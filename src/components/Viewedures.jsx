...
{resource.resourceType === 'image' && (
  <img src={resource.content} alt="img" className="w-full max-h-[500px] object-contain rounded-lg mt-3" />
)}
{resource.resourceType === 'video' && (
  <video controls className="w-full max-h-[600px] rounded-lg mt-3 object-contain">
